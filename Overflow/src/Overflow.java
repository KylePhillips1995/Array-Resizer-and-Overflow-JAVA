...
public class Overflow {
	...
	public static void main(String[] args) {
		...
		//checks to see if the size of the array given is less than the length and if not asks for a new input
		while(vals.length <= s1.length()) {
			
		System.out.println("String is to large! ");
			s1 = getString(scan);
